...
(13, 'Mercedes-Benz', 'AMG GT', "The Mercedes-Benz AMG GT has been one of our favorite sports cars since its debut in 2016. What could make it even better? Well, Mercedes seems to think an extra pair of doors. The new 2019 AMG GT 4-Door Coupe doesn\'t offer S-Class levels of luxury, however. Instead, it trades rear-seat accommodations for a far more engaging driving experience. Of the brand\'s sporty four-doors, this one is certainly the most performance-oriented. The base model comes with Mercedes\' new turbocharged inline-six paired to a mild hybrid system. We like this powertrain in other Benzes, but it\'s safe to say that the 4.0-liter V8 that comes in the GT 63 is the one to get. Not only does it produce significantly more power than the inline-six, but choosing the V8 also adds mechanical upgrades that should make the sedan truly feel like a four-door sports car. Along with the likes of the Porsche Panamera and the 2020 BMW 8 Series Gran Coupe, the new AMG GT 4-Door Coupe should serve you well if you\'re looking for an adrenaline-charged combination of luxury and performance. Edmunds\' Expert Rating 7.2 / 10 Trim tested Each vehicle typically comes in multiple versions that are fundamentally similar. The ratings in this review are based on our full test of the Mercedes-Benz AMG GT 53 Sedan (turbo 3.0L inline-6 | 9-speed automatic | AWD).", 'carimgs/13.jpg', 68000, 2);
